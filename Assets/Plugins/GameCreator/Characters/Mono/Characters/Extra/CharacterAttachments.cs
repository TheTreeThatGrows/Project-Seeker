namespace GameCreator.Characters
{
    ...
    public class CharacterAttachments : MonoBehaviour
    {
        ...
        public List<GameObject> Hide(HumanBodyBones bone)
        {
            return this.HideOrShow(bone, false);
        }

        public bool Hide(GameObject instance)
        {
            return this.HideOrShow(instance, false);
        }

        public List<GameObject> Show(HumanBodyBones bone)
        {
            return this.HideOrShow(bone, true);
        }

        public bool Show(GameObject instance)
        {
            return this.HideOrShow(instance, true);
        }
        ...
        private List<GameObject> DetachOrDestroy(HumanBodyBones bone, bool destroy)
        {
         ...
         private List<GameObject> HideOrShow(HumanBodyBones bone, bool show)
         {
                ...
                for (int i = 0; i < objects.Count; ++i)
                    {
                        if (objects[i] != null && objects[i].instance != null)
                            {
                                objects[i].instance.SetActive(show);
                            }
                    }
             }
        ...
        private bool HideOrShow(GameObject instance, bool show)
        {
