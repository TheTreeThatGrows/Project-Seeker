namespace GameCreator.Accessibility
{
	...
	[AddComponentMenu("")]
    public class ActionVariableToDecrypt : IAction
    {
        ...
        public static new string NAME = "Accessibility/Cognitive/Variable To Decrypt";
        private const string NODE_TITLE = "Variable To Decrypt";
