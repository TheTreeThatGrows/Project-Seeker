namespace GameCreator.Accessibility
{
	...
	[AddComponentMenu("")]
    public class ActionTMPEncryptToVariable : IAction
    {
        ...
        public override bool InstantExecute(GameObject target, IAction[] actions, int index)
        {
            if (this.tmptext != null)
            {
                ...
                byte[] encrypted = encrypting(this.tmptext.text, encryptKey);
	    ...
	    public static new string NAME = "Accessibility/Cognitive/TMP_Encrypt to Variable";
	    private const string NODE_TITLE = "TMP_Encrypt to Variable";
